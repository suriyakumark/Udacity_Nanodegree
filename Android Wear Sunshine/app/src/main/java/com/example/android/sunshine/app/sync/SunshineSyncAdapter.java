    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                if(i==0) {
                    Log.v(LOG_TAG, "WearableSync");
                    String weatherData = new String("");
                    weatherData = (int) high + ";" + (int) low + ";" + weatherId + ";" + System.currentTimeMillis() + ";";
                    WearableSync wearableSync = new WearableSync(context, WEAR_MESSAGE_PATH, weatherData);
                }
