...
public class ArticleDetailFragment extends Fragment implements
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            bodyView.setContentDescription(bodyView.getText());

            //Log.v("Article Fragment - ",bodyView.getText().toString());
    ...
    private String getShareContent(){
        String shareContent = "";
        shareContent += titleView.getText() + "\n";
        shareContent += bylineView.getText() + "\n\n";
        shareContent += bodyView.getText();
        return shareContent;
    }
