...
public class PutActivitiesSyncAdapter extends AbstractThreadedSyncAdapter {
    public final String TAG = PutActivitiesSyncAdapter.class.getSimpleName();
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            getActivitiesDataFromJson(articleJsonStr);
        } catch (IOException e) {
            Log.e(TAG, "Error ", e);
     ...
     */
    private void getActivitiesDataFromJson(String articleJsonStr)
