...
public class SleepingFragment extends Fragment {
    ...
    static final int COL_SLEEPING_DATE = 3;
    static final int COL_SLEEPING_TIME = 4;
    static final int COL_SLEEPING_DURATION = 5;
    static final int COL_SLEEPING_WHERE_SLEEP = 6;
    static final int COL_SLEEPING_NOTES = 7;
